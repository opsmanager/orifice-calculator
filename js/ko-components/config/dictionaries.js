(function() {
  define("orifice-calculator-config", function() {
    ...
    this.OPL.OrificeCalculator.Config.Dictionaries.PressureUnits = [
      {
        displayName: "Psi",
        key: "psi"
      }, {
    ...
    this.OPL.OrificeCalculator.Config.Dictionaries.BaseSpecificGravity = {
      air: {
        name: "Air",
        value: 1
      },
    ...
    this.OPL.OrificeCalculator.Config.Dictionaries.OrificeBoreDiameterUnits = {
      inches: "Inches",
    ...
    return this.OPL.OrificeCalculator.Config.Dictionaries.FlowRateTimeUnits = {
      minute: "Minute",
      hour: "Hour",
      day: "Day",
      second: "Second"
